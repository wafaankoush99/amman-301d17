...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: "rando variable is not defined because we used a local variable outside of its scope (const is block scope contrary to var)."
  console.log(viewed);
